...
public interface ProfileMapper {
    ...
    Profile toEntity(ProfileRequestDto profileRequestDto,
                     @Context PassportRepository passportRepository,
                     @Context ActualRegistrationRepository actualRegistrationRepository);
    ...
    default ActualRegistration idToActualRegistration(
            Long id,
            @Context ActualRegistrationRepository actualRegistrationRepository) {
        return (id != null && actualRegistrationRepository != null) ?
                actualRegistrationRepository.findById(id).orElse(null) : null;
    }
}
