...
public class PassportController {
    ...
    @Operation(summary = "Create Passport",
            description = "Creating passport and unique identifier assigning. Follows model's " +
    ...
    public ResponseEntity<PassportResponseDto> update(
            @Valid @RequestBody PassportRequestDto passportRequestDto, @PathVariable Long id) {
        final PassportResponseDto passportResponseDto = passportService.update(id, passportRequestDto);
        return ResponseEntity.ok(passportResponseDto);
    }
    ...
    public ResponseEntity<PassportResponseDto> getById(@PathVariable Long id) {
        final PassportResponseDto passportResponseDto = passportService.getById(id);
        return ResponseEntity.ok(passportResponseDto);
    }
    ...
    public ResponseEntity<List<PassportResponseDto>> getAll() {
        final List<PassportResponseDto> passportResponseDto = passportService.getAll();
        return ResponseEntity.ok(passportResponseDto);
    }
